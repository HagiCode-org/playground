...
public sealed class StdioAcpTransport : IAcpTransport
{
    private readonly KimiProcessRunner _processRunner;
    ...
    public StdioAcpTransport(KimiProcessRunner processRunner, RawTranscriptCapture transcript)
    {
