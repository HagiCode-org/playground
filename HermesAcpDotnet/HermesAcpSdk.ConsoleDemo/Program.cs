...
Console.WriteLine("Hermes ACP Console Demo");
...
static void PrintFeatureSummary(HermesRunResult result)
{
...
internal sealed class DemoArguments
{
    ...
    public HermesRunRequest ToRunRequest()
    {
        return new HermesRunRequest
        {
